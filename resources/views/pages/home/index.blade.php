                                                ...
                                                <ul class="list-inline">
                                                    ...
                                                    <li>
                                                        <h6 class="text-muted  text-info"><i
                                                                class="fa fa-circle font-10 m-r-10"></i>Earning ($)
                                                        </h6>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block">
                                    <h4 class="card-title">Earning Report<br /><small class="text-muted">Emplyee
                                            earning report</small></h4>
                                    <div class="ml-auto">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="../assets/images/users/1.jpg"
                                                    alt="user" /></div>
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="../assets/images/users/2.jpg"
                                                    alt="user" /></div>
                                            <div class="chat-content">
                                                <h5>Bianca Doe</h5>
                                        ...
                                        <li class="reverse">
                                            ...
                                            <div class="chat-img"><img src="../assets/images/users/5.jpg"
                                                    alt="user" /></div>
                                            <div class="chat-time">10:57 am</div>
                                        </li>
                                        <!--chat Row -->
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="../assets/images/users/3.jpg"
                                                    alt="user" /></div>
                                            <div class="chat-content">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item" data-role="task">
                                            <div class="checkbox checkbox-info">
                                                ...
                                                <label for="inputSchedule" class=""> <span>Schedule meeting
                                                        with</span> </label>
                                            </div>
                                            <ul class="assignedto">
                                        ...
                                        <li class="list-group-item" data-role="task">
                                            <div class="checkbox checkbox-info">
                                                ...
                                                <label for="inputCall" class=""> <span>Give Purchase report
                                                        to</span> <span class="label label-danger">Today</span>
                                                </label>
                                            </div>
                                            <ul class="assignedto">
                                                <li><img src="../assets/images/users/3.jpg" alt="user"
                                        ...
                                        <li class="list-group-item" data-role="task">
                                            <div class="checkbox checkbox-info">
                                                ...
                                                <label for="inputBook" class=""> <span>Book flight for
                                                        holiday</span> </label>
                                            </div>
                                        ...
                                        <li class="list-group-item" data-role="task">
                                            <div class="checkbox checkbox-info">
                                                ...
                                                <label for="inputForward" class=""> <span>Forward all
                                                        tasks</span> <span class="label label-warning">2 weeks</span>
                                                </label>
                                            </div>
                                            <div class="item-date"> 26 jun 2017</div>
                                        </li>
                                        <li class="list-group-item" data-role="task">
                                            <div class="checkbox checkbox-info">
                                                ...
                                                <label for="inputRecieve" class=""> <span>Recieve
                                                        shipment</span> </label>
                                            </div>
                                            <div class="item-date"> 26 jun 2017</div>
                                        </li>
                                        <li class="list-group-item" data-role="task">
                                            <div class="checkbox checkbox-info">
                                                ...
                                                <label for="inputForward2" class=""> <span>Important
                                                        tasks</span> <span class="label label-success">2 weeks</span>
                                                </label>
                                            </div>
                                            <ul class="assignedto">
                                                <li><img src="../assets/images/users/1.jpg" alt="user"
                                                ...
                                                <div class="m-t-20 row">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            ...
                                                            diam. </p> <a href="#" class="btn btn-success">
                                                            Design weblayout</a>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-lg-4 col-xlg-3">
                        ...
                        <div class="card">
                            <div class="card-body bg-inverse"
                                style="background: url(../assets/images/background/user-info.jpg) / cover;">
